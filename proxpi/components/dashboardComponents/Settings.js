...
import { ResourceList, Button, Tooltip, Icon } from "@auth0/cosmos";
      ...
      <div class="settings-container mainbody nmorphism-container">
        ...
        <div style={{ margin: "1%" }}>
          ...
          <small id="emailHelp" class="form-text text-muted">
            ...
            access the Proxy API . If the Access is set to public the
            permissions shall not apply. The restriction will only be made if
